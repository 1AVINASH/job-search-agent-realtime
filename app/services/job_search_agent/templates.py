...
class Templates:
    ...
    def remote_mail(self):
        return os.getenv("REMOTE_MAIL") or self.REMOTE_MAIL
    
    @property
    def generic_cover_letter(self):
        return os.getenv("GENERIC_COVER_LETTER") or self.GENERIC_COVER_LETTER
    @property
    def remote_mail(self):
        return os.getenv("JOBS_PARSER") or self.JOBS_PARSER
