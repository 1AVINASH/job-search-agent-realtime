...
class JobSearchLinkedAgent:
    ...
    def search_query(self):
        return templates.linkedin_job_search_query
    ...
    def has_more_urls(self, state: GraphState):
        if state.get("urls") and self.jobs_scraped<self.max_jobs_to_scrape:
            return "visit"
        else:
            return END
    ...
    def _initialize_workflow(self):
        ...
        self.workflow.add_conditional_edges("search", self.has_more_urls, {
            "visit": "visit",
            END: END
        })
    ...
    def run(self):
        ...
        file_location = f"/output/raw/linkedin-remote_jobs-{current_datetime}.csv"
